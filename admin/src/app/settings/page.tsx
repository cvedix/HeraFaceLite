...
export default function SettingsPage() {
  ...
  return <main className={styles.page}>
    ...
    <div className={styles.grid}>
      ...
      <section className={styles.card}><span className={styles.kicker}>Môi trường chạy</span><h2>Thông tin thiết bị</h2><div className={styles.apiRow}><span>Thiết bị</span><b>HeraFace node 01</b></div><div className={styles.apiRow}><span>Model</span><b>SeetaFace6</b></div><div className={styles.apiRow}><span>Cơ sở dữ liệu</span><b>42 embeddings</b></div><div className={styles.apiRow}><span>Thời gian hoạt động</span><b>3 ngày, 4 giờ</b></div></section>
    </div>
  </main>;
}
